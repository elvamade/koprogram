...
internal sealed class SendMultiMediaHandler(
    ...
    IMediaHelper mediaHelper, //IRequestCacheAppService requestCacheAppService,
    ...
    : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestSendMultiMedia, MyTelegram.Schema.IUpdates>
{
    ...
    protected override async Task<IUpdates> HandleCoreAsync(IRequestInput input, RequestSendMultiMedia obj)
    {
        ...
        foreach (var inputSingleMedia in obj.MultiMedia)
        {
            ...
            var sendMessageInput = new SendMessageInput(requestInfo, input.UserId, toPeer, inputSingleMedia.Message, inputSingleMedia.RandomId, clearDraft: obj.ClearDraft, entities: inputSingleMedia.Entities, media: media, //replyToMsgId: replyToMsgId,
        ...
        await paidMessagesAppService.ChargePaidMessagesAsync(input.UserId, toPeer, obj.AllowPaidStars, groupItemCount);
