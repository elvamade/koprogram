    ...
    : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestForwardMessages, MyTelegram.Schema.IUpdates>
{
    protected override async Task<IUpdates> HandleCoreAsync(IRequestInput input, RequestForwardMessages obj)
    {
        ...
        {
            RpcErrors.RpcErrors420.FrozenMethodInvalid.ThrowRpcError();
        }
        ...
        await paidMessagesAppService.ChargePaidMessagesAsync(input.UserId, toPeer, obj.AllowPaidStars, obj.Id.Count);
