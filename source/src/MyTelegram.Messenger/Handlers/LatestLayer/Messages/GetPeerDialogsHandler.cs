...
/// </remarks>
internal sealed class GetPeerDialogsHandler(IDialogAppService dialogAppService, IPeerHelper peerHelper, IPtsHelper ptsHelper, IAccessHashHelper accessHashHelper, IQueryProcessor queryProcessor, IUserConverterService userConverterService, IDialogConverterService dialogConverterService, IUserAppService userAppService) : RpcResultObjectHandler<RequestGetPeerDialogs, IPeerDialogs>
{
    protected override async Task<IPeerDialogs> HandleCoreAsync(IRequestInput input, RequestGetPeerDialogs obj)
    {
        ...
        {
            RpcErrors.RpcErrors400.FrozenParticipantMissing.ThrowRpcError();
        }
