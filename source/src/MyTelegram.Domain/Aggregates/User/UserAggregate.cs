...
public class UserAggregate : MyInMemorySnapshotAggregateRoot<UserAggregate, UserId, UserSnapshot>
{
    ...
    public void FreezeAccount(bool frozen)
    {
        Specs.AggregateIsCreated.ThrowDomainErrorIfNotSatisfied(this);
        Emit(new UserFrozenHasSetEvent(frozen));
    }
    ...
    protected override Task<UserSnapshot> CreateSnapshotAsync(CancellationToken cancellationToken)
    {
        return Task.FromResult(new UserSnapshot(_state.UserId,
            ...
            _state.EmojiStatusCollectibleTitle,
            _state.EmojiStatusCollectibleSlug,
            _state.EmojiStatusCollectiblePatternDocumentId,
            _state.EmojiStatusCollectibleCenterColor,
            _state.EmojiStatusCollectibleEdgeColor,
            _state.EmojiStatusCollectiblePatternColor,
            _state.EmojiStatusCollectibleTextColor,
