...
public class MyTelegramConsts
{
    ...
    public const int MaxCreatedBroadcastChannelCount = 10;
    public const int MaxCreatedChatCount = 5;
    public const int MaxJoinedChannelCount = 500;
    public const int SendCodeLimitPerHour = 5;
    public const int SignUpLimitPerHour = 10;
    public const int NonContactInviteLimitPerDay = 30;
