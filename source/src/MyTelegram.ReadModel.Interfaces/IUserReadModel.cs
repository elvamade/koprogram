...
public interface IUserReadModel : IReadModel
{
    ...
    string? EmojiStatusCollectibleTitle { get; }
    string? EmojiStatusCollectibleSlug { get; }
    long? EmojiStatusCollectiblePatternDocumentId { get; }
    int? EmojiStatusCollectibleCenterColor { get; }
    int? EmojiStatusCollectibleEdgeColor { get; }
    int? EmojiStatusCollectiblePatternColor { get; }
    int? EmojiStatusCollectibleTextColor { get; }
