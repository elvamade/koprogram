...
public class UserReadModel : IUserReadModel,
    ...
    IAmReadModelFor<UserAggregate, UserId, UserFrozenHasSetEvent>,
    ...
    IAmReadModelFor<UserAggregate, UserId, UserFirstNameUpdatedEvent>
{
    ...
    public long? BotVerificationIcon { get; private set; }
    public bool TestLabel { get; private set; }
    ...
    public Task ApplyAsync(IReadModelContext context, IDomainEvent<UserAggregate, UserId, UserFrozenHasSetEvent> domainEvent, CancellationToken cancellationToken)
    {
        Frozen = domainEvent.AggregateEvent.Frozen;
    ...
    public Task ApplyAsync(IReadModelContext context, IDomainEvent<UserAggregate, UserId, UserEmojiStatusUpdatedEvent> domainEvent, CancellationToken cancellationToken)
    {
        ...
        RecentEmojiStatuses.Add(emojiStatus.DocumentId);
        if (RecentEmojiStatuses.Count > 10)
        {
            RecentEmojiStatuses.RemoveAt(0);
        }
