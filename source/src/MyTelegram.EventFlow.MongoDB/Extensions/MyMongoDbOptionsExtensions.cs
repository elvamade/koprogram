...
#pragma warning restore CS0618
    ...
    /// <summary>
    /// Register a query-only read model store for models that are populated externally (not via EventFlow aggregates)
    /// </summary>
    public static IEventFlowOptions UseMongoDbQueryOnlyReadModel<TReadModel>(
        this IEventFlowOptions eventFlowOptions)
        where TReadModel : class, IMongoDbReadModel
    {
        eventFlowOptions.ServiceCollection
