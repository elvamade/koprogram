...
public sealed partial class TStarGift : ILayeredStarGift
{
    ...
    public void Serialize(IBufferWriter<byte> writer)
    {
        ...
        if (Flags.IsBitSet(11)) { writer.Write(AuctionSlug ?? string.Empty); }
        if (Flags.IsBitSet(11)) { writer.Write(GiftsPerRound.GetValueOrDefault()); }
        if (Flags.IsBitSet(11)) { writer.Write(AuctionStartDate.GetValueOrDefault()); }
