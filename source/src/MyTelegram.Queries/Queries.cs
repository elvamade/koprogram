...
public record GetCreatedChannelCountByCreatorQuery(long CreatorUserId, bool Broadcast) : IQuery<int>;

public record GetJoinedChannelCountQuery(long UserId) : IQuery<int>;
...
public record GetStarGiftsByIdsQuery(List<long> GiftIds) : IQuery<IReadOnlyCollection<IStarGiftReadModel>>;
